        ...
        <div class="col-md-4 mb-3">
            <div class="card text-white shadow h-100" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="card-body">
                    ...
                    <h2 class="card-text mb-0 fw-bold display-5">{{ number_format($totalTransaksi, 0, ',', '.') }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card text-white shadow h-100" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                <div class="card-body">
                    ...
                    <h2 class="card-text mb-0 fw-bold display-5">{{ number_format($totalBukuTerjual, 0, ',', '.') }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card text-white shadow h-100" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                <div class="card-body">
                    ...
                    <h2 class="card-text mb-0 fw-bold" style="font-size: 1.75rem;">Rp{{ number_format($totalPendapatan, 0, ',', '.') }}</h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        @forelse ($transaksi as $index => $trx)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-info">{{ $trx->detailTransaksi->sum('jumlah') }} item</span>
                                </td>
                                <td class="text-end">
                        ...
                        <tfoot class="table-light">
                            <tr>
                                ...
                                <th class="text-end text-success">
                                    <strong class="fs-4">Rp{{ number_format($totalPendapatan, 0, ',', '.') }}</strong>
                                </th>
                            </tr>
                        </tfoot>
                    @endif
